...
*** replication
est clear
qui eststo tc1a_1: reghdfe t_drive d1gp_bp_at14 d1gp_bp_at15 d1gp_bp_at16 d1gp_bp_at17 ///
					d1gp_bp_at18 d1gp_bp_at19 if m_samestate==1 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
qui eststo tc1a_2: reghdfe t_drive d1gp_bp_at13 d1gp_bp_at14 d1gp_bp_at15 d1gp_bp_at16 d1gp_bp_at17 ///
					d1gp_bp_at18 d1gp_bp_at19 d1gp_bp_at20 if m_samestate==1 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)

local tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) order(d1gp_bp_at13 d1gp_bp_at14 d1gp_bp_at15 d1gp_bp_at16 d1gp_bp_at17 d1gp_bp_at18 d1gp_bp_at19 d1gp_bp_at20) nocons nomtitle

esttab 	tc1a_*, replace `tabprefs' 
esttab 	tc1a_* using "$tables/table4_reproduction.tex", replace `tabprefs' 
...
local tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) order(d1gp_bp_at13 d1gp_bp_at14 d1gp_bp_at15 d1gp_bp_at16 d1gp_bp_at17 d1gp_bp_at18 d1gp_bp_at19 d1gp_bp_at20) nocons mtitles("$\mathbbm{1}[\text{transit}]$" "$\mathbbm{1}[\text{transit}]$" "$\mathbbm{1}[\text{vehicle}]$" "$\mathbbm{1}[\text{vehicle}]$")
