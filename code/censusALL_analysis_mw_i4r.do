...
*------------------------------------------------
*** Table 1 Row 1: replication
*------------------------------------------------
lab var d2gp_bp_at17 "$\Delta$ Price"

qui eststo tc2b_1:	reghdfe t_drive d2gp_bp_at17 if m_samestate==1 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
...
qui eststo tc2b_2:	reghdfe t_drive d2gp_bp_at17 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
...
qui eststo tc2b_3:	reghdfe t_drive d2gp_bp_at17 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
estadd local sample "All"
...
** MW: put d_* in absorb()
qui eststo tc2b_4:	reghdfe t_drive d2gp_bp_at17 if m_samestate==1 [aw=perwt], a(bpl censusyear_all age d_fem d_marr d_hs d_col d_black d_hisp) cluster(bpl)
estadd local sample "Stay"
estadd local price_state "Birth"
estadd local cy_fe "Yes"
estadd local sob_fe "Yes"
...
qui eststo tc2b_5:	reghdfe t_drive d2gp_bp_at17 lhhi if m_samestate==1 [aw=perwt], a(bpl censusyear_all age d_fem d_marr d_hs d_col d_black d_hisp) cluster(bpl)
estadd local sample "Stay"
estadd local price_state "Birth"
estadd local cy_fe "Yes"
estadd local sob_fe "Yes"
...
qui eststo tc2b_6:	reghdfe t_drive d2gp_bp_at17 lhhi if m_samestate==1 [aw=perwt], a(stcenyr_fe age  d_fem d_marr d_hs d_col d_black d_hisp) cluster(bpl)
estadd local sample "Stay"
estadd local price_state "Birth"
estadd local cy_fe ""
estadd local sob_fe ""
...
qui eststo tc2b_7:	reghdfe t_drive d2gp_bp_at17 lhhi c.byr##c.byr 	if m_samestate==1 [aw=perwt], a(stcenyr_fe age  d_fem d_marr d_hs d_col d_black d_hisp) cluster(bpl)
estadd local sample "Stay"
estadd local price_state "Birth"
estadd local cy_fe ""
estadd local sob_fe ""
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")

esttab 	tc2b_* , replace `tabprefs' 
esttab tc2b_* using "$tables/table1_reproduction.tex",  replace `tabprefs'
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17 d2gp_bp_at17_by71) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17 d2gp_bp_at17_fem) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17 d2gp_bp_at17_black) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17 d2gp_bp_at17_pos) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17_neg d2gp_bp_at17_pos) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income"  "price_state Price in state of" "sample Sample") eqlabels(none)
*local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_at17) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample") eqlabels(none)
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_atp1 d2gp_bp_atp1_pos) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_atp1_neg d2gp_bp_atp1_pos) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
local 	tabprefs b(%9.4f) p ar2 label star(* 0.1 ** 0.05 *** 0.01) nomtitle keep(d2gp_bp_atp1) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "dem Demographics" "inc ln HH income" "sy_fe State $\times$ year FEs" "q_by Quad. birth year" "price_state Price in state of" "sample Sample")
...
est clear
qui eststo tother_b_1:	reghdfe t_transit d2gp_bp_at17 if m_samestate==1 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
estadd local cy_fe "Yes"
estadd local sob_fe "Yes"
estadd local dem ""
estadd local inc ""
...
qui eststo tother_b_2:	reghdfe t_transit d2gp_bp_at17 c.byr##c.byr d_* lhhi if m_samestate==1 [aw=perwt], a(stcenyr_fe age) cluster(bpl)
estadd local cy_fe ""
estadd local sob_fe ""
estadd local dem "Yes"
estadd local inc "Yes"
...
qui eststo tother_b_3:	reghdfe t_vehicle d2gp_bp_at17 if m_samestate==1 & mi(t_transit)==0 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
estadd local cy_fe "Yes"
estadd local sob_fe "Yes"
estadd local dem ""
estadd local inc ""
...
qui eststo tother_b_4:	reghdfe t_vehicle d2gp_bp_at17 c.byr##c.byr d_* lhhi if m_samestate==1 & mi(t_transit)==0 [aw=perwt], a(stcenyr_fe age) cluster(bpl)
estadd local cy_fe ""
estadd local sob_fe ""
estadd local dem "Yes"
estadd local inc "Yes"
...
qui eststo tother_b_5:	reghdfe t_vehicle d2gp_bp_at17 if m_samestate==1 [aw=perwt], a(bpl censusyear_all age) cluster(bpl)
estadd local cy_fe "Yes"
estadd local sob_fe "Yes"
estadd local dem ""
estadd local inc ""
...
qui eststo tother_b_6:	reghdfe t_vehicle d2gp_bp_at17 c.byr##c.byr d_* lhhi if m_samestate==1 [aw=perwt], a(stcenyr_fe age) cluster(bpl)
estadd local cy_fe ""
estadd local sob_fe ""
estadd local dem "Yes"
estadd local inc "Yes"
...
esttab tother_b_* using "$tables/table2_reproduction.tex",  replace `tabprefs'
...
local 	tabprefs b(%9.4f) p label star(* 0.1 ** 0.05 *** 0.01) keep(d2gp_bp_at17) scalars("cy_fe Census year FEs" "sob_fe State of birth FEs" "sample Sample") mtitles("$\mathbbm{1}[\text{transit}]$" "$\mathbbm{1}[\text{vehicle}]$" "$\mathbbm{1}[\text{vehicle}]$") eqlabels(none)
